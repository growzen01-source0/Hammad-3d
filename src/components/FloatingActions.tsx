    ...
    <>
      ...
      <div className="fixed top-1/2 -translate-y-1/2 right-3 sm:right-6 z-40 pointer-events-none">
        ...
        >
          <button
            ...
            className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-[#090d14]/90 backdrop-blur-xl border border-white/15 hover:border-[#8B5CF6]/70 text-neutral-300 hover:text-[#8B5CF6] flex items-center justify-center shadow-[0_8px_30px_rgba(0,0,0,0.6)] hover:shadow-[0_0_32px_rgba(139,92,246,0.55)] transition-all duration-[350ms] ease-in-out transform hover:scale-110 hover:-translate-x-1 active:scale-95 cursor-pointer group relative overflow-hidden"
          >
            {/* Soft inner ambient glow aura on hover */}
            <div className="absolute inset-0 bg-radial from-[#8B5CF6]/30 via-[#8B5CF6]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-[350ms] ease-in-out pointer-events-none" />
      ...
      <div className="fixed bottom-4 sm:bottom-6 left-4 sm:left-6 z-40">
        <a
          ...
          className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-linear-to-br from-[#8B5CF6] to-[#22D3EE] text-[#0D0D14] flex items-center justify-center shadow-[0_0_25px_rgba(139,92,246,0.45)] hover:shadow-[0_0_40px_rgba(139,92,246,0.85)] transition-all duration-[300ms] ease-in-out transform hover:scale-110 hover:-translate-y-1 active:scale-95 group relative cursor-pointer"
        >
          {/* Outer radar wave */}
          <span className="absolute inset-0 rounded-full bg-[#8B5CF6] opacity-40 animate-ping pointer-events-none" />

          <MessageCircle className="w-6 h-6 sm:w-7 sm:h-7 fill-current relative z-10" />

          {/* Hover Tooltip */}
          <div className="absolute left-full ml-3 top-1/2 -translate-y-1/2 px-3 py-1.5 rounded-xl bg-[#0a0d13]/90 border border-[#8B5CF6]/30 text-[#8B5CF6] text-xs font-mono-tech whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-[300ms] ease-in-out pointer-events-none shadow-xl backdrop-blur-md hidden sm:block">
