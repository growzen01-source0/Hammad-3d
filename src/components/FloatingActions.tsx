...
export const FloatingActions: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-4 sm:bottom-6 left-4 sm:left-6 z-40 transition-all duration-[300ms] ease-in-out transform ${
          showBackToTop
      ...
      <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-40">
        ...
        >
          ...
          {/* Hover Tooltip */}
          <div className="absolute right-full mr-3 top-1/2 -translate-y-1/2 px-3 py-1.5 rounded-xl bg-[#0a0d13]/90 border border-[#10f48e]/30 text-[#10f48e] text-xs font-mono-tech whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-[300ms] ease-in-out pointer-events-none shadow-xl backdrop-blur-md hidden sm:block">
