  ...
  return (
    <div
      ...
      className={`rounded-2xl sm:rounded-3xl p-5 sm:p-7 md:p-8 flex flex-col justify-between transition-all duration-300 relative cursor-pointer group glass-panel select-none perspective-1000 ${
        isHovered
          ? 'border-[#10f48e]/70 shadow-[0_25px_60px_rgba(0,0,0,0.8),0_0_40px_rgba(16,244,142,0.3)] bg-[#0c1219]/95'
          : 'border-white/10 hover:border-white/20'
      } ${isPopular ? 'border-[#10f48e]/50 holo-border' : ''}`}
      style={{
        opacity: inView ? 1 : 0,
        transform: inView
    ...
    >
      ...
      {isPopular && (
        <div
          ...
          className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-linear-to-r from-[#10f48e] to-[#00d075] text-[#060709] text-[11px] font-bold font-mono-tech uppercase tracking-wider shadow-[0_0_25px_#10f48e] flex items-center gap-1.5 z-30"
        >
      ...
      <div style={{ transform: isHovered ? 'translateZ(25px)' : 'translateZ(0px)', transition: 'transform 0.2s ease-out' }}>
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-display font-bold text-2xl text-white group-hover:text-[#10f48e] transition-colors">
            {pkg.name}
          </h3>
        ...
        <div className="p-4 rounded-2xl bg-white/5 border border-white/5 mb-6 flex items-baseline gap-2 shadow-inner">
          <span className="font-display font-black text-3xl sm:text-4xl text-white group-hover:text-[#10f48e] transition-colors drop-shadow-[0_0_12px_rgba(16,244,142,0.4)]">
            {pkg.price}
          </span>
        ...
        {/* Delivery Time */}
        <div className="flex items-center gap-2 text-xs font-mono-tech text-[#10f48e] mb-6">
      ...
      >
        <button
          ...
          className={`w-full py-3.5 rounded-2xl text-xs font-bold uppercase font-mono-tech tracking-wider transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer ${
            isPopular
              ? 'bg-linear-to-r from-[#10f48e] to-[#00d075] text-[#060709] shadow-[0_0_30px_rgba(16,244,142,0.5)] hover:scale-105'
              : 'bg-white/10 text-white hover:bg-[#10f48e] hover:text-[#060709] hover:shadow-[0_0_20px_rgba(16,244,142,0.4)]'
          }`}
        >
...
export const PricingSection: React.FC<PricingSectionProps> = ({ onSelectPackage }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/3 w-96 h-96 rounded-full bg-[#10f48e]/8 blur-[170px] pointer-events-none" />
      ...
      <div className="mt-10 sm:mt-12 flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-xs font-mono-tech text-neutral-400 px-2">
        <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/[0.03] hover:bg-[#10f48e]/5 border border-white/10 hover:border-[#10f48e]/40 hover:text-neutral-200 transition-all duration-[350ms] ease-in-out transform hover:scale-105 hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(16,244,142,0.18)] cursor-default group">
          <Shield className="w-4 h-4 text-[#10f48e] transition-transform duration-[350ms] ease-in-out group-hover:scale-110 group-hover:rotate-6" />
          <span>No Long-Term Lock-in — Cancel or upgrade anytime</span>
        </div>
        <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/[0.03] hover:bg-[#10f48e]/5 border border-white/10 hover:border-[#10f48e]/40 hover:text-neutral-200 transition-all duration-[350ms] ease-in-out transform hover:scale-105 hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(16,244,142,0.18)] cursor-default group">
          <BarChart3 className="w-4 h-4 text-[#10f48e] transition-transform duration-[350ms] ease-in-out group-hover:scale-110 group-hover:-translate-y-0.5" />
          <span>Transparent Milestones — Track progress every step of the way</span>
        </div>
        <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/[0.03] hover:bg-[#10f48e]/5 border border-white/10 hover:border-[#10f48e]/40 hover:text-neutral-200 transition-all duration-[350ms] ease-in-out transform hover:scale-105 hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(16,244,142,0.18)] cursor-default group">
          <MessageSquare className="w-4 h-4 text-[#10f48e] transition-transform duration-[350ms] ease-in-out group-hover:scale-110 group-hover:rotate-3" />
